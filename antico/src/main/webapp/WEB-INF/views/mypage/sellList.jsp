	        ...
	        success: function (json) {
	        	if(json.length > 0){
					   ...
					   $.each(json, function(index, item){
					       ...
					       const idx = word.toLowerCase().indexOf($("input[name='search_sell']").val().toLowerCase());
						
					       const len = $("input[name='search_sell']").val().length; 
					   ...
					   const input_width = $("input[name='search_sell']").css("width"); // 검색어 input 태그 width 값 알아오기  
					   
					   $("div#sell_history").html(v_html).show();
				   }
			   },
